                    ...
                    <TableBody displayRowCheckbox={false}>
                        {basket.map(item => products[item.product_id] && (
                            <TableRow key={item.product_id}>
                                ...
                                <TableRowColumn style={{ textAlign: 'right' }}>
                                    {products[item.product_id].price.toLocaleString(undefined, { style: 'currency', currency: 'BRL' })}
                                </TableRowColumn>
                                <TableRowColumn style={{ textAlign: 'right' }}>
                                    {item.quantity}
                                </TableRowColumn>
                                <TableRowColumn style={{ textAlign: 'right' }}>
                                    {(products[item.product_id].price * item.quantity).toLocaleString(undefined, { style: 'currency', currency: 'BRL' })}
                                </TableRowColumn>
                            </TableRow>)
                        )}
                        <TableRow>
                            ...
                            <TableRowColumn style={{ textAlign: 'right' }}>
                                {record.total_ex_taxes.toLocaleString(undefined, { style: 'currency', currency: 'BRL' })}
                            </TableRowColumn>
                        </TableRow>
                        <TableRow>
                            <TableRowColumn colSpan={2} />
                            ...
                            <TableRowColumn style={{ textAlign: 'right' }}>
                                {record.delivery_fees.toLocaleString(undefined, { style: 'currency', currency: 'BRL' })}
                            </TableRowColumn>
                        </TableRow>
                        <TableRow>
                            <TableRowColumn colSpan={2} />
                        ...
                        <TableRow>
                            ...
                            <TableRowColumn style={{ textAlign: 'right', fontWeight: 'bold' }}>
                                {record.total.toLocaleString(undefined, { style: 'currency', currency: 'BRL' })}
                            </TableRowColumn>
                        </TableRow>
                    </TableBody>
                </Table>
