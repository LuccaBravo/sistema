...
const Configuration = ({ theme, locale, changeTheme, changeLocale, translate }) => (
    <Card>
        ...
        <CardText>
            ...
            <RaisedButton style={styles.button} label="Pt-br" primary={locale === 'en'} onClick={() => changeLocale('en')} />
            <RaisedButton style={styles.button} label="Es" primary={locale === 'fr'} onClick={() => changeLocale('fr')} />
        </CardText>
    </Card>
);
