...
export default translate(({ style, translate }) => (
    <Card style={style}>
        ...
        <CardActions style={{ textAlign: 'right' }}>
            ...
            <FlatButton label={translate('pos.dashboard.welcome.demo_button')} icon={<CodeIcon />} href="http://realtruckcenter.com.br/"/>
        </CardActions>
    </Card>
));
/*https://github.com/marmelab/admin-on-rest-demo https://marmelab.com/admin-on-rest/*/
